...
**Primary:** Microsoft Dynamics 365 CE, Dataverse, Power Automate, Plugins (C#), FetchXML, SSRS
...
* Maintained and extended LOS for banking operations using custom plugins, workflows and API optimization to improve reliability and reduce latency.

### Selling Point Unit Management System

* Designed and implemented a full CRM system from BRD to production, delivering plugins, workflows, and reports to boost sales visibility.

### Real Estate CRM

* Optimized AngularJS visual mapping and integrated a forecasting model for pricing. Built a cost‑efficient alternative to Canvas Apps for resilience.

### CRM Extension & Mobile App
